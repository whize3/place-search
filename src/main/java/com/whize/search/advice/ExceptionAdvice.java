package com.whize.search.advice;
...
public class ExceptionAdvice {
    ...
    @ExceptionHandler(CApiCallException.class)
    public CommonResult CApiCallException(HttpServletRequest request, AccessDeniedException e) {
        return responseService.getFailResult(Integer.valueOf(getMessage("apiCallError.code")), getMessage("apiCallError.msg"));
    }
